                ...
                <div class="col-md-10 col-md-offset-1">
                    <ul id="menu-pricing" class="menu-price">
                        ...
                        <li class="item" id="{{ $item->category->slug }}">
                            <a href="#">
                                <img src="{{ asset('upload/item/'.$item->image) }}" class="img-responsive" alt="Item" style="height: 200px;width: 300px">
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="copyright text-center">
                    <p>
                        &copy; Copyright, 2018 <a href="#">anower</a> Developed by <a href=""  target="_blank">Anower</a>
                    </p>
                </div>
            </div>
        </div>
